...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the wazzle repository."
  exit 1
fi
...
# See https://github.com/wazzle/wazzle/issues/16064
...
echo 'When compiling wazzled, run `./configure` in the following way:'
echo
