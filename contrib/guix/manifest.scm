...
(define* (make-wazzle-cross-toolchain target
                                  #:key
...
desirable for building Wazzle Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-wazzle-cross-toolchain "i686-linux-gnu")
       (make-wazzle-cross-toolchain "x86_64-linux-gnu")
       (make-wazzle-cross-toolchain "aarch64-linux-gnu")
       (make-wazzle-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-wazzle-cross-toolchain "riscv64-linux-gnu"
