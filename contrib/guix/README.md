# Bootstrappable Wazzle Core Builds

This directory contains the files necessary to perform bootstrappable Wazzle
Core builds.
...
- 24GB of free disk space on the partition that the Wazzle Core git repository
  resides in
...
For a Wazzle Core depends development environment, simply invoke
...
From the top of a clean Wazzle Core repository:
...
To use dongcarl's substitute server for Wazzle Core builds after having
