...
class P2PPermissionsTests(WazzleTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].wazzleconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].wazzleconf, 'w', encoding="utf8") as f:
            f.write(newText)
