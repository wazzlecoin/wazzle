...
By default, wazzled will dump mempool on shutdown and
...
class MempoolPersistTest(WazzleTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent wazzled from writing mempool.dat to disk. Verify that `savemempool` fails")
