...
class SegWitTest(WazzleTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older wazzled's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let wazzled fill it in.
