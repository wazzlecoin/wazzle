...
"""Verify that starting wazzle with -h works as expected."""

from test_framework.test_framework import WazzleTestFramework
from test_framework.util import assert_equal

class HelpTest(WazzleTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wazzle with -h for help text")
        ...
        self.log.info("Start wazzle with -version for version information")
        ...
        self.log.info("Start wazzled with -fakearg to make sure it does not start")
