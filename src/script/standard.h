...
#ifndef WAZZLE_SCRIPT_STANDARD_H
#define WAZZLE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a wazzle address
 */
...
/**
 * Generate a Wazzle scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // WAZZLE_SCRIPT_STANDARD_H
