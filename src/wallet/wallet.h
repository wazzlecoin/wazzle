...
#ifndef WAZZLE_WALLET_WALLET_H
#define WAZZLE_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! wazzle from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Wazzle Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this wazzle node, and set to 0 for transactions that were created
