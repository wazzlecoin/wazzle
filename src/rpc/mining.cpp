...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated wazzle to."},
            ...
            + "If you are running the wazzle core wallet, you can get a new address to send the newly generated wazzle to with:\n"
...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/wazzle/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/wazzle/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/wazzle/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/wazzle/bips/blob/master/bip-0145.mediawiki\n",
                {
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    // We allow 2 arguments for compliance with BIP22. Argument 2 is ignored.
            RPCHelpMan{"submitblock",
                ...
                "See https://en.wazzle.it/wiki/BIP_0022 for full specification.\n",
                {
