...
#ifndef WAZZLE_CRYPTO_CHACHA_POLY_AEAD_H
#define WAZZLE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@wazzle.
 *
 ...
 *
 * The chacha20-poly1305@wazzle combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@wazzle cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@wazzle are relatively fast in
...
#endif // WAZZLE_CRYPTO_CHACHA_POLY_AEAD_H
