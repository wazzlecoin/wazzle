// Copyright (c) 2018-2019 The Wazzle Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef WAZZLE_INTERFACES_CHAIN_H
#define WAZZLE_INTERFACES_CHAIN_H
...
//! internal workings of the wazzle node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/wazzle/wazzle/pull/10973#issuecomment-380101269).
//!
//! * The initMessage() and showProgress() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/wazzle/wazzle/pull/15288#discussion_r253321096).
//!
...
#endif // WAZZLE_INTERFACES_CHAIN_H
