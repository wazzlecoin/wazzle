...
#ifndef WAZZLE_QT_GUIUTIL_H
#define WAZZLE_QT_GUIUTIL_H
...
/** Utility functions used by the Wazzle Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "wazzle:" URI into recipient object, return true on successful parsing
