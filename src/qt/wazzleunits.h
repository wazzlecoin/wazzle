...
#ifndef WAZZLE_QT_WAZZLEUNITS_H
#define WAZZLE_QT_WAZZLEUNITS_H
...
/** Wazzle unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class WazzleUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit WazzleUnits(QObject *parent);

    /** Wazzle units.
      @note Source: https://en.wazzle.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        WAZ,
...
typedef WazzleUnits::Unit WazzleUnit;

#endif // WAZZLE_QT_WAZZLEUNITS_H
