    ...
    mapper(nullptr)
{
    ...
    ui->wazzleAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->wazzleAtStartup);
    ...
    ui->wazzleAtStartup->setToolTip(ui->wazzleAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->wazzleAtStartup->setText(ui->wazzleAtStartup->text().arg(PACKAGE_NAME));

    ui->openWazzleConfButton->setToolTip(ui->openWazzleConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new WazzleUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->wazzleAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openWazzleConfButton_clicked()
{
