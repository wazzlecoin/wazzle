    ...
    platformStyle(_platformStyle)
{
    ...
    // normal wazzle address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying wazzle address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &WazzleAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
