...
#ifndef WAZZLE_QT_SPLASHSCREEN_H
#define WAZZLE_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Wazzle Core initialization
...
#endif // WAZZLE_QT_SPLASHSCREEN_H
