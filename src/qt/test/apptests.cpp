...
//! Entry point for WazzleApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &WazzleApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for WazzleGUI tests.
void AppTests::guiTests(WazzleGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &WazzleGUI::consoleShown, this, &AppTests::consoleTests);
