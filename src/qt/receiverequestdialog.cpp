...
#include <config/wazzle-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatWazzleURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + WazzleUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatWazzleURI(info));
}
