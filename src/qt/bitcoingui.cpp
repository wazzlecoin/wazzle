...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a iBTC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and iBTC: URIs)"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to iBTC network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
