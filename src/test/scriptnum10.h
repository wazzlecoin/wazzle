...
#ifndef WAZZLE_TEST_SCRIPTNUM10_H
#define WAZZLE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Wazzle Core 0.10.0, for cross-comparison.
 */
public:
