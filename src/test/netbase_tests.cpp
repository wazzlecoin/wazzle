// Copyright (c) 2012-2019 The Wazzle Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.wazzlecore.org", "www.wazzlecore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.wazzlecore.org]", "www.wazzlecore.org", -1));
    BOOST_CHECK(TestSplitHost("www.wazzlecore.org:80", "www.wazzlecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.wazzlecore.org]:80", "www.wazzlecore.org", 80));
