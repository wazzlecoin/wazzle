...
#ifndef WAZZLE_COMPAT_ASSUMPTIONS_H
#define WAZZLE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Wazzle cannot be compiled without assertions."
#endif
...
#endif // WAZZLE_COMPAT_ASSUMPTIONS_H
