...
// wazzle includes.
#include <..\src\script\wazzleconsensus.h>
...
int main()
{
    std::cout << "wazzleconsensus version: " << wazzleconsensus_version() << std::endl;
    ...
    auto op0Result = wazzleconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, wazzleconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
