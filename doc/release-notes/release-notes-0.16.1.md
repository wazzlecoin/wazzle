Wazzle Core version 0.16.1 is now available from:

  <https://wazzlecore.org/bin/wazzle-core-0.16.1/>
...
- #12843 `df38b13` Test starting wazzled with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure wazzled processes are cleaned up when tests end (sdaftuar)
