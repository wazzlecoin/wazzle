Wazzle-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wazzle/files/Wazzle/wazzle-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Wazzle
...
New/changed settings (command-line or wazzle.conf file)
--------------------------------------------------------
