Wazzle Core version 0.13.2 is now available from:

  <https://wazzle.org/bin/wazzle-core-0.13.2/>
...
- #8908 `4a974b2` Update wazzle-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow wazzle-tx to create v2 transactions (btcdrak)
