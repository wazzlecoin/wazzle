Wazzle Core version 0.10.4 is now available from:

  <https://wazzle.org/bin/wazzle-core-0.10.4/>
...
- #6953 `43c2789` Split wazzle-tx into its own package
- #6953 `dfe0d4d` Include wazzle-tx binary on Debian/Ubuntu
