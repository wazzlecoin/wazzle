Wazzle Core version *0.15.2* is now available from:

  <https://wazzlecore.org/bin/wazzle-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in wazzle-tx (TheBlueMatt)
