Wazzle Core version 0.9.4 is now available from:

  https://wazzle.org/bin/0.9.4/
...
this update is incompatible with the Wazzle system and could lead to consensus
forks.

Wazzle Core released binaries from https://wazzle.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~wazzle/+archive/ubuntu/wazzle
- A third-party or self-compiled Wazzle Core

upgrade to Wazzle Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
