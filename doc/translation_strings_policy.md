...
This document provides guidelines for internationalization of the Wazzle Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wazzle_en.ts` remains unchanged.
