...
Wazzle Core version 0.19.1 is now available from:

  <https://wazzlecore.org/bin/wazzle-core-0.19.1/>
...
From Wazzle Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Wazzle Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Wazzle Core does not yet change appearance when
...
- #17488 fix "wazzled already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/wazzle/wazzle/).
