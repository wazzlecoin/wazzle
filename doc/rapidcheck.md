# RapidCheck property-based testing for Wazzle Core

## Concept

Property-based testing is experimentally being added to Wazzle Core with
...
If RapidCheck is installed, Wazzle Core will automatically run the
...
3. Configure Wazzle Core with RapidCheck.

    `cd` to the directory of your local wazzle repository and run
...
4. Build Wazzle Core with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_wazzle-crypto_gen.o
    CXX      test/test_wazzle-key_properties.o
    ```
...
That's it! You are now running property-based tests in Wazzle Core.
